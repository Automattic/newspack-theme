...
function newspack_custom_colors_css() {
	...
	$theme_css = '
		...
		/* Set color that contrasts against the primary background */
		...
		.widget a,
		.entry .entry-content .wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):link {
